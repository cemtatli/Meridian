  ...
  return (
    <div className="h-screen-64 w-full overflow-auto">
      <div className="flex h-full flex-col items-center">
        <Banner />
        {/* ------ */}
        <div className="flex h-fit w-full flex-col border-b border-thunder-100 px-4 py-5 dark:border-opacity-20">
          ...
          <span className="text-center text-sm text-thunder-500  dark:text-white md:text-start md:text-base">
            @{user?.username}
          </span>
          <span className="text-center text-sm text-thunder-500  dark:text-white md:text-start md:text-base">
            {user?.bio}
