  ...
  return (
    <div className="h-screen-64 w-full overflow-auto">
      <div className="flex h-full flex-col items-center">
        {/* ------ */}
        <div className="flex h-fit w-full flex-col gap-y-2 border-thunder-100 px-4 py-5 dark:border-opacity-20">
          <div className="w-full items-center justify-center">
            <div className="flex items-center justify-center gap-y-0.5 ">
              <Avatar ring={true} src={user?.avatar} />
            </div>
            <h2 className="pt-2 text-center text-lg font-bold text-primary-dark dark:text-white md:text-2xl">
              {user?.fullName}
            </h2>
            <div className="w-full text-center text-sm text-thunder-500  dark:text-white md:text-base">
              @{user?.username}
            </div>
          ...
          <span className="text-center text-sm text-thunder-500  dark:text-white  md:text-base">{user?.bio}</span>
          {/* ------ */}
