...
const Navbar = () => {
  return (
    <header className="fixed bottom-0 z-40 flex h-14 w-full items-center border-t border-ocean-950 border-opacity-10 bg-transparent bg-white shadow dark:border-white dark:border-opacity-10 dark:bg-primary-dark md:sticky md:top-0 ">
